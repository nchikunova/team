const Lsi = {
  appName: {
    cs: "Aplikace myProject",
    en: "Application myProject",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci myProject",
      en: "About application myProject",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní myProject.",
      en: "You can buy your own myProject.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci myProject.",
      en: "You don't have rights to initialize this myProject.",
    },
  },
